...
3. If yes: check whether `spek-fu/features/<branch-name>/spec.md` exists.
4. Output JSON to stdout:
    {"spec-context": true/false, "feature-dir": "spek-fu/features/<branch>/", "branch": "<name>"}
...
def main():
    ...
    # Check if spec.md exists in spek-fu/features/<branch>/
    feature_dir = f"spek-fu/features/{branch}/"
    spec_path = os.path.join(workspace_root, "spek-fu", "features", branch, "spec.md")
