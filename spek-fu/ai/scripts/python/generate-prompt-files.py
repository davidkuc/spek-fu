...
Discovers all plugins under spek-fu/ai/plugins/, reads their skills-index.json files,
...
Usage: python3 spek-fu/ai/scripts/python/generate-prompt-files.py
...
def main() -> int:
    ...
    workspace_root = Path(common.get_repo_root())
    plugins_dir = workspace_root / "spek-fu" / "ai" / "plugins"
