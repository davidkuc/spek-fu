...
spek-fu/ai/plugins/skf/skills/config.json.
...
Usage:
    python3 spek-fu/ai/scripts/python/gather-skills.py
    python3 spek-fu/ai/scripts/python/gather-skills.py --format table
    python3 spek-fu/ai/scripts/python/gather-skills.py --format json
    python3 spek-fu/ai/scripts/python/gather-skills.py --config path/to/config.json
    python3 spek-fu/ai/scripts/python/gather-skills.py --plugins-index path/to/plugins-index.json

Options:
    --format FORMAT         Output format: json (default) or table.
    --config PATH           Path to config.json relative to repo root
                            (default: spek-fu/ai/plugins/skf/skills/config.json).
    --plugins-index PATH    Path to plugins-index.json relative to repo root
                            (default: spek-fu/ai/plugins/plugins-index.json).
...
# Repository root is resolved via the durable root marker.
REPO_ROOT = Path(common.get_repo_root())

DEFAULT_PLUGINS_INDEX = "spek-fu/ai/plugins/plugins-index.json"
DEFAULT_CONFIG = "spek-fu/ai/plugins/skf/skills/config.json"
