...
Usage:
    python3 spek-fu/ai/scripts/python/get-skf-index-children.py --index-path spek-fu/ai/ai-index.json
    python3 spek-fu/ai/scripts/python/get-skf-index-children.py --index-path spek-fu/ai/ai-index.json --json
