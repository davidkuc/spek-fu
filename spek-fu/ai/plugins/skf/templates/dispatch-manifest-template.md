...
- If artifact exceeds 20 KB after compaction, write to `spek-fu/reports/orchestration-spill/{wave}-{step}-{skill-id}-output.md` first, then reference path in Output path
