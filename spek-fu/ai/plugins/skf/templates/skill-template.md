...
- For large artifacts (>20 KB), first compact wording while preserving meaning; if fidelity still cannot fit, write full result to `spek-fu/reports/orchestration-spill/{wave}-{step}-{skill-id}-output.json`
