...
> Use this template when formatting the output of Step 7 in the orchestrator workflow. Replace all `{placeholder}` fields. Write the completed summary to a file at `spek-fu/reports/orchestration-summary-{YYYY-MM-DD-HHmmss}.md`.
