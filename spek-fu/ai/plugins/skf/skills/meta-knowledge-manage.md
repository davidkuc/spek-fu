...
Expected behavior: Reads knowledge-database.md, determines next ID. Drafts lesson with Trigger/Context/Solution. Presents via vscode_askQuestions. On Approve, appends lesson and reports "Lesson #N recorded in spek-fu/ai/plugins/skf/knowledge/knowledge-database.md."
</example>
