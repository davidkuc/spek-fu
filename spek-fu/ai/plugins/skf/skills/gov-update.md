...
**Permitted write targets**: `spek-fu/constitution/`, `spek-fu/project/`, `spek-fu/ai/`, `.github/`. No writes outside these folders, ever.
...
`devcontainer`: read `spek-fu/ai/plugins/skf/knowledge/devcontainer-guidelines.md` fully and apply all rules before Step 1.
...
- `spek-fu/constitution/` — behavioral rules, coding standards, or principles changed
- `spek-fu/project/` — requirements, specs or ADR content changed
- `spek-fu/ai/` and `.github/` — skills, agents, prompts, runbooks, knowledge, or patterns changed
...
<reminders>
- NEVER write outside `spek-fu/constitution/`, `spek-fu/project/`, `spek-fu/ai/`, `.github/`.
