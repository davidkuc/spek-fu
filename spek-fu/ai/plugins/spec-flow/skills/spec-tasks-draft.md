...
<tools>
- **read_file**: Load spec.md, data-model.md, research.md, quickstart.md, tdd-designer/report.md, the tasks template, `spek-fu/ai/plugins/spec-flow/knowledge/branch-detection.md`, and `spek-fu/ai/plugins/skf/knowledge/devcontainer-guidelines.md` (in devcontainer environments). Apply `spek-fu/ai/plugins/spec-flow/knowledge/paginated-read.md` whenever a file may span multiple reads.
...
Output: spek-fu/features/001-user-auth/tasks.md
