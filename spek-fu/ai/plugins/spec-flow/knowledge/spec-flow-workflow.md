...
- **Template**: `spek-fu/ai/plugins/spec-flow/templates/devils-advocate-template.md`
...
- **Template**: `spek-fu/ai/plugins/spec-flow/templates/testability-template.md`
...
- **Template**: `spek-fu/ai/plugins/spec-flow/templates/tdd-report-template.md`
...
- **Template**: `spek-fu/ai/plugins/spec-flow/templates/tasks-template.md`
...
- **Template**: `spek-fu/ai/plugins/spec-flow/templates/feature-analysis-template.md`
