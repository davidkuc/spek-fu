...
<examples>
<example>
Invocation: "Read skill at spek-fu/ai/plugins/skf/skills/impl-implement.md and apply the change described in plan.md."
...
<example>
Invocation: "Read skill at spek-fu/ai/plugins/skf/skills/orch-resume-detect.md and check whether this workflow can be resumed."
