...
1. Using the wave execution task records provided as input, compose the wave summary following the template at `ai/plugins/skf/templates/wave-summary-template.md`.
