...
> **Normative reference**: `ai/plugins/skf/templates/dispatch-manifest-template.md` defines the canonical markdown manifest format. `ai/plugins/skf/templates/wave-summary-template.md` defines the canonical wave summary format.
